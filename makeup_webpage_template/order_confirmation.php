...
if (!$order && isset($_SESSION['pending_order']) && intval($_SESSION['pending_order']['order_id']) === $order_id) {
...
if (!$order) {
    ...
    echo "<h1>Order Not Found</h1><p>The order you're looking for doesn't exist or has expired.</p>";
    echo "<p><a href='index.html'>Go to Home</a></p></body></html>";
    exit;
}
